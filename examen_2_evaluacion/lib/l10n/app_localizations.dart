...
abstract class AppLocalizations {
  ...
  /// No description provided for @drawerTitulo.
  ///
  /// In es, this message translates to:
  /// **'Gestor de libreria'**
  String get drawerTitulo;

  /// No description provided for @drawerGestion.
  ///
  /// In es, this message translates to:
  /// **'Gestion'**
  String get drawerGestion;

  /// No description provided for @drawerListado.
  ///
  /// In es, this message translates to:
  /// **'Listado'**
  String get drawerListado;

  /// No description provided for @drawerAjustes.
  ///
  /// In es, this message translates to:
  /// **'Ajustes'**
  String get drawerAjustes;

  /// No description provided for @vistaGestion.
  ///
  /// In es, this message translates to:
  /// **'Gestión'**
  String get vistaGestion;
  ...
  /// No description provided for @listado.
  ///
  /// In es, this message translates to:
  /// **'Listado'**
  String get listado;

  /// No description provided for @libroEliminado.
  ///
  /// In es, this message translates to:
  /// **'Libro eliminado'**
  String get libroEliminado;
